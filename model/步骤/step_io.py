...
输入/输出变量或常量，可访问全局变量树 :class:`model.变量.variable_tree.VariableTree`。
...
class StepIOWidget:
    ...
    def error_reasons(self) -> List[str]:
        ...
        （宿主以「⚠: 」前缀拼接展示，见 :class:`widgets.卡片.step_list_view.StepListView`）。
        """
        out: List[str] = []
...
# ================================================================
# 冒烟演示：直接 ``python -m model.步骤.step_io`` 运行
# ================================================================
