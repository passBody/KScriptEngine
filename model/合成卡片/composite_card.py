...
:class:`model.合成卡片.composite_card_store.CompositeCardStore`）。

本类继承 :class:`model.步骤.step.Step`，因此可像普通步骤一样被卡片视图渲染、复制剪切、
序列化、由执行器调度。区别仅在：
...
from model.合成卡片.composite_local_tree import build_local_tree
from model.合成卡片.composite_signature import CompositeSignature, Param
...
# ================================================================
# 冒烟演示：直接 ``python -m model.合成卡片.composite_card`` 运行
# ================================================================
