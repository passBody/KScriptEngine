...
``@合成卡片:<路径>``（见 :class:`model.合成卡片.composite_card.CompositeCard`），运行时
...
# ================================================================
# 冒烟演示：直接 ``python -m model.合成卡片.composite_card_store`` 运行
# ================================================================
...
'''
    ...
    from model.步骤.step import Step  # noqa: E402  供类型注解
